...
#
#
#   In order to perform a simulation  : $OSOAA_ROOT/exe/run_OSOAA.csh 
#
#
#######################################################################################

setenv dirRESULTS ${OSOAA_ROOT}/OSOAA_RESULTS

setenv dirMIE_AER ${OSOAA_ROOT}/DATABASE/MIE_AER  && mkdir -p ${dirMIE_AER}
setenv dirMIE_HYD ${OSOAA_ROOT}/DATABASE/MIE_HYD  && mkdir -p ${dirMIE_HYD} 
setenv dirSURF ${OSOAA_ROOT}/DATABASE/SURF_MATR   && mkdir -p ${dirSURF}
...
${OSOAA_ROOT}/exe/OSOAA_MAIN.exe \
	 ...
	 -OSOAA.Wa 0.443 \
         -ANG.Rad.NbGauss 48    -ANG.Rad.ResFile LUM_UsedAngles.txt \
	 -ANG.Mie.NbGauss 40    -ANG.Mie.ResFile AER_UsedAngles.txt \
	 -AER.ResFile AER_Granu.txt -ANG.Log Trace_Angles.Log \
         -ANG.Thetas 30. \
	 -AER.Waref 0.550 -AER.AOTref 0.1  \
	 -AER.DirMie ${dirMIE_AER} -AER.MieLog Trace_AerMie.Log \
	 -AER.Model 0 \
         -AER.MMD.MRwa 1.4 -AER.MMD.MIwa -0.0001 \
	 -AER.MMD.MRwaref 1.39 -AER.MMD.MIwaref -0.0002 \
         -AER.MMD.SDtype 1  -AER.MMD.JD.slope 3.0 -AER.MMD.JD.rmin 0.2 -AER.MMD.JD.rmax 50. \
	 -AER.MMD.LNDradius 5.2 -AER.MMD.LNDvar 0.3 \
	 -AER.WMO.Model 4\
	 -AER.WMO.DL 0.1 -AER.WMO.WS 0.2 -AER.WMO.OC 0.3 -AER.WMO.SO 0.5\
	 -AER.SF.Model 4 -AER.SF.RH 90.\
	 -AER.BMD.VCdef 1 -AER.BMD.CoarseVC  0.95 -AER.BMD.FineVC 0.05 \
	 -AER.BMD.CM.MRwa 1.530 -AER.BMD.CM.MIwa -0.0050 -AER.BMD.CM.SDradius 0.8  -AER.BMD.CM.SDvar 0.26 \
	 -AER.BMD.CM.MRwaref 1.550 -AER.BMD.CM.MIwaref -0.0150 \
	 -AER.BMD.FM.MRwa 1.430 -AER.BMD.FM.MIwa -0.010 -AER.BMD.FM.SDradius 0.1  -AER.BMD.FM.SDvar 0.17 \
	 -AER.BMD.FM.MRwaref 1.420 -AER.BMD.FM.MIwaref -0.0110 \
	 -AER.ExtData "./monFicPhaseFct.txt" \
	 -AER.Log Trace_Aerosols.Log \
	 -HYD.Log Trace_hydrosols.Log \
	 -PHYTO.ResFile Phyto_Granu.txt -MLP.ResFile Sediments_Granu.txt \
	 -HYD.DirMie ${dirMIE_HYD} -HYD.MieLog Trace_HydMie.Log \
	 -HYD.Model 1 \
	 -PHYTO.JD.slope 3.0 -PHYTO.JD.rmin 0.01 -PHYTO.JD.rmax 200. \
	 -PHYTO.JD.MRwa 1.05 -PHYTO.JD.MIwa -0.000 -PHYTO.JD.rate 0.5 \
	 -PHYTO.LND.SM.SDradius 0.3 -PHYTO.LND.SM.SDvar 0.4 \
	 -PHYTO.LND.SM.MRwa 1.1 -PHYTO.LND.SM.MIwa -0.005 -PHYTO.LND.SM.rate 0.3\
	 -PHYTO.LND.TM.SDradius 0.1 -PHYTO.LND.TM.SDvar 0.2 \
	 -PHYTO.LND.TM.MRwa 1.1 -PHYTO.LND.TM.MIwa 0.0 -PHYTO.LND.TM.rate 0.2\
	 -SED.JD.slope 4.0 -SED.JD.rmin 0.01  \
	 -SED.JD.MRwa 1.20 -SED.JD.MIwa -0.005 -SED.JD.rate 1.0 \
	 -HYD.ExtData "./monFicPhaseFct_Sea.txt" \
	 -AP.Pressure 1023.0  -AP.HR 8.0 -AP.HA 2.0 \
	 -SEA.Depth 15.000 \
	 -PHYTO.Chl 0.2 \
	 -SED.Csed  0.1 -PHYTO.ProfilType 1 \
	 -YS.Abs440 0.99  -DET.Abs440 0.88 \
	 -PROFILE_ATM.ResFile PROFILE_ATM.txt  \
	 -PROFILE_SEA.ResFile PROFILE_SEA.txt  \
	 -PROFILE.Log Trace_Profils.Log \
	 -SEA.Dir ${dirSURF} \
	 -SEA.Ind 1.34  -SEA.Wind 0  -SEA.Log Trace_Surface.Log \
	 -SEA.SurfAlb 0.1  -SEA.BotType 1 -SEA.BotAlb 0.30 \
 	 -OSOAA.View.Phi 0.0 \
	 -OSOAA.View.Level 5\
         -OSOAA.View.Z -10.032 -OSOAA.ResFile.vsVZA RESLUM_vsVZA.txt \
	 -OSOAA.View.VZA 31.24 -OSOAA.ResFile.vsZ RESLUM_vsZ.txt \
         -OSOAA.ResFile.Adv.Up RESLUM_Advanced_UP.txt \
         -OSOAA.ResFile.Adv.Down RESLUM_Advanced_DOWN.txt \
         -SOS.Log Trace_SOS.Log \
         -SOS.IGmax  50 \
         -SOS.ResFile.Bin RESLUM.bin
